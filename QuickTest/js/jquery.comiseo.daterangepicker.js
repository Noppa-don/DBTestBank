...
(function($, window, undefined) {
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			initialText: '4LiB', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'ตกลง', // use '' to get rid of the button
			//clearButtonText: 'Clear', // use '' to get rid of the button
			cancelButtonText: 'ยกเลิก', // use '' to get rid of the button
