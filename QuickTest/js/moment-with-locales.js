...
;(function (global, factory) {
    ...
    var th = moment__default.defineLocale('th', {
        months : 'Á¡ÃÒ¤Á_¡ØÁÀÒ¾Ñ¹¸ì_ÁÕ¹Ò¤Á_àÁÉÒÂ¹_¾ÄÉÀÒ¤Á_ÁÔ¶Ø¹ÒÂ¹_¡Ã¡®Ò¤Á_ÊÔ§ËÒ¤Á_¡Ñ¹ÂÒÂ¹_µØÅÒ¤Á_¾ÄÈ¨Ô¡ÒÂ¹_¸Ñ¹ÇÒ¤Á'.split('_'),
        monthsShort : 'Á.¤._¡.¾._ÁÕ.¤._àÁ.Â._¾.¤._ÁÔ.Â._¡.¤._Ê.¤._¡.Â._µ.¤._¾.Â._¸.¤.'.split('_'),
        monthsParseExact: true,
        weekdays : 'ÍÒ·ÔµÂì_¨Ñ¹·Ãì_ÍÑ§¤ÒÃ_¾Ø¸_¾ÄËÑÊº´Õ_ÈØ¡Ãì_àÊÒÃì'.split('_'),
        weekdaysShort : 'ÍÒ·ÔµÂì_¨Ñ¹·Ãì_ÍÑ§¤ÒÃ_¾Ø¸_¾ÄËÑÊ_ÈØ¡Ãì_àÊÒÃì'.split('_'), // yes, three characters difference
        weekdaysMin : 'ÍÒ._¨._Í._¾._¾Ä._È._Ê.'.split('_'),
        weekdaysParseExact : true,
        longDateFormat : {
            LT : 'H ¹ÒÌÔ¡Ò m ¹Ò·Õ',
            LTS : 'H ¹ÒÌÔ¡Ò m ¹Ò·Õ s ÇÔ¹Ò·Õ',
            L : 'YYYY/MM/DD',
            LL : 'D MMMM YYYY',
            LLL : 'D MMMM YYYY àÇÅÒ H ¹ÒÌÔ¡Ò m ¹Ò·Õ',
            LLLL : 'ÇÑ¹dddd·Õè D MMMM YYYY àÇÅÒ H ¹ÒÌÔ¡Ò m ¹Ò·Õ'
        },
        meridiemParse: /¡èÍ¹à·ÕèÂ§|ËÅÑ§à·ÕèÂ§/,
        isPM: function (input) {
            return input === 'ËÅÑ§à·ÕèÂ§';
        },
        meridiem : function (hour, minute, isLower) {
            if (hour < 12) {
                return '¡èÍ¹à·ÕèÂ§';
        ...
        calendar : {
            sameDay : '[ÇÑ¹¹Õé àÇÅÒ] LT',
            nextDay : '[¾ÃØè§¹Õé àÇÅÒ] LT',
            nextWeek : 'dddd[Ë¹éÒ àÇÅÒ] LT',
            lastDay : '[àÁ×èÍÇÒ¹¹Õé àÇÅÒ] LT',
            lastWeek : '[ÇÑ¹]dddd[·ÕèáÅéÇ àÇÅÒ] LT',
            sameElse : 'L'
        },
        relativeTime : {
            future : 'ÍÕ¡ %s',
