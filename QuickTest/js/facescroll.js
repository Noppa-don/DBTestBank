    ...
    var methods = {
        init: function (options) {
            this.each(function () {
                ...
                $scrollObj.wrapInner('<div class="alt-scroll-holder" style="position: relative;"><div class="alt-scroll-content" style="position: absolute; top: 0; left: 0;right: 0px;"></div></div>');
                ...
                if (($verticalBar.css('background-color') == 'rgba(0, 0, 0, 0)') && ($verticalBar.css('background-image') == 'none')) $verticalBar.css('background-color', 'rgba(0, 0, 0, 0.49)');
                if (($verticalBar.css('background-color') == 'transparent') && ($verticalBar.css('background-image') == 'none')) $verticalBar.css('background-color', 'rgba(0, 0, 0, 0.49)');
                if (parseInt($verticalBar.css('width')) == 0 || $verticalBar.css('width') == 'auto') $verticalBar.css({ 'width': 30, 'border-radius': 3, 'cursor': 'default' });
                var verticalBarWidth = $verticalBar.width();
                //                var verticalBarHeight = Math.floor(scrollHolderHeight * verticalBarMultiplier);
                var verticalBarHeight = 120;
                $verticalBar.height(verticalBarHeight - parseInt($verticalBar.css('margin-bottom')));
                //$verticalBar.height(100);
                ...
                if (parseInt($horizontalBar.css('height')) == 0 || $horizontalBar.css('height') == 'auto') $horizontalBar.css({ 'height': 30, 'border-radius': 3, 'cursor': 'default' });
