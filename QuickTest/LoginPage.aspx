...
<body>
    ...
    <form id="contact" runat="server" defaultbutton="btnLogin">
        ...
        <div id="main">
            <div id="logo" style="text-align: center; margin: auto;">
                <img class="imgLogo" style="vertical-align: middle; margin: 50px 50px 0 100px;" src="./images/Logo.png" alt="logo" />
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="style5" style="display: block;">
                                        <asp:TextBox ID="txtusername" runat="server" class="contact" value="" Width="249px" ClientIDMode="Static"></asp:TextBox>
                                    </td>
                                    <td class="style4" style="vertical-align: middle;">
