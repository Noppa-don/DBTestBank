<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ViewReportMain.aspx.vb"
    Inherits="QuickTest.ViewReportMain" %>
    ...
    var JSChooseMode = '<%=ChooseMode %>';
     var t360SchoolId = '<%=T360SchoolId %>';
        ...
        if (JSChooseMode == 1) {
            $('#imgHome').click(function(){
             if (t360SchoolId !== "") {
             window.location = '<%=ResolveUrl("~")%>ViewReport/ViewReportReduce.aspx?DashboardMode=' + JSChooseMode;
...
//            });
        ...
        function setRoomFromSelected(classSelected) {
             $.ajax({ type: "POST",
                  url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/createRoomFormSelectedClass",
        ...
        function setQuizFromSelected(classRoomSelected) {
             $.ajax({ type: "POST",
                  url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/createQuizFromRoomSelected",
        ...
        function disabledCheckboxClass(){
            $.ajax({ type: "POST",
                  url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/createClassRoom",
        ...
        function CreatePieChartOnLoad() {
         ...
         //var ValPracticeMode = $('#HdPracticeMode').val();
               $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreatePieChartOnLoad",
	            data: "{ ChooseMode: '" + JSChooseMode + "'}",  //" 
	            contentType: "application/json; charset=utf-8", dataType: "json",   
    ...
    var Data2 = $('#HdTypeChart').val();
     var InputSort = $('#HdTopOrLow').val();
       $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartMainLevel",
        ...
        function CreateChartAllRoomInClassChoose(Data1) {
         OpenBlockUI();
           ...
           var Data2 = $('#HdTypeChart').val();
              var InputSort = $('#HdTopOrLow').val();
         $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartAllRoomInClassChoose",
        ...
        function CreateChartClass(Data1) { 
         OpenBlockUI();
           ...
           var Data2 = $('#HdTypeChart').val();
            var InputSort = $('#HdTopOrLow').val();
           $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartClass",
        ...
        function CreateChartRoom(Data1) {
         OpenBlockUI();
          ...
          var InputSort = $('#HdTopOrLow').val();
        $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartRoom",
       ...
       $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartActivity",
      ...
      var Data2;
           ...
           $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartActivityPerQuiz",
        ...
        function CreateChartAvgStudentScoreByTestSetId(DataInput) {
         OpenBlockUI();
           //var ValPracticeMode = $('#HdPracticeMode').val();
         var OriginalData = DataInput;
          var Data3 = $('#HdTypeChart').val();
      ...
      var Data2;
           ...
           $.ajax({ type: "POST",
	            url: "<%=ResolveUrl("~")%>ViewReport/ViewReportMain.aspx/CreateChartAvgStudentScoreByTestSetId",
	            data: "{ StrRoom: '" + Data1 + "', StrActivity: '" + Data2 + "' ,TypeChart:'" + Data3 + "',SortType: '" + CheckSort + "',ChooseMode:'" + JSChooseMode + "'}",  //" 
	            contentType: "application/json; charset=utf-8", dataType: "json",   
	            success: function (msg) {
                    nextCmd = msg.d;
                    //alert(nextCmd);
                    ...
                    CloseBlockUI();   
                     $('#HdRightPanel').val('7' + '$' + OriginalData) ;
	            },
	            error: function myfunction(request, status)  {
                //alert('บางอย่างผิดพลาดโปรดลองอีกครั้ง')
	                //alert('shin' + request.statusText + status);    
         ...
         $('#HdTypeChart').val('2');
          $('#HdTopOrLow').val('0');
          var CompleteData1 = ArrData[1];
            CreateChartAvgStudentScoreByTestSetId(CompleteData1,CompleteData2,'0');
            }
         ...
         $('#HdTypeChart').val('3');
          $('#HdTopOrLow').val('0');
          var CompleteData1 = ArrData[1];
            CreateChartAvgStudentScoreByTestSetId(CompleteData1,CompleteData2);
            }
         ...
         //$('#HdTypeChart').val('1');
            var CompleteData1 = ArrData[1];
            CreateChartAvgStudentScoreByTestSetId(CompleteData1,CompleteData2,TopOrLow);
            }
  ...
  function ClearNotMatchSearch(txtSearch) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.divList').click(function () {
                ...
                $('input[type=checkbox]').click(function () {
                    if ($(this).hasClass('primaryClass') || $(this).hasClass('secondClass')) {
                        $('#classSelected').addClass('changeSelected');
                    }
                    else if ($(this).hasClass('classRoom')) {
                        $('#roomSelected').addClass('changeSelected');
                    }
            ...
            $('#imgReportPersonal').click(function () {
                window.location = '<%=ResolveUrl("~")%>ViewReport/viewReportPersonal.aspx?DashboardMode=' + JSChooseMode;
            });
    ...
    function SetSesstionCalendarId(CalendarId, CalendarName) {
        ...
        //เมื่อกดปุ่ม เลือกแต่ชุดมาตรฐาน
        ...
        //เมื่อกดปุ่มเลือกชุดที่ครูจัดไว้
...
<body>
    ...
    <div class="mainDiv" style='width: 990px; height: auto; margin-left: auto; margin-right: auto;
                        ...
                        <tr>
                            <td>
                                <div class="divMenuLeft" style='position: relative; left: 6px; z-index: 2;'>
                                    <img src="../Images/reportGraph/btnHome-Overview.png" style='margin-top: 10px; margin-left: 10px;
                                    ...
                                    <img src="../Images/reportGraph/btnViewSingle.png" style="width: 50px; height: 50px;
                                        margin-top: 10px; position: relative; right: -50px; top: 7px;" title='ดูคะแนนแบบรายตัว'
                                        id="imgReportPersonal" /><br />
                                    ...
                                    <div style="position: relative; background-color: #FFC76F; margin-top: 20px;">
                                        <div class="divList" id="classSelected" title="เลือกชั้นเรียนค่ะ">
                                            ระดับชั้น<%--<span style="float: right;">→</span>--%><%--<img src="../Images/reportGraph/ShowRightFrame-Orange.png" style="float:right;"  />--%>
                                        </div>
                                        <div class="divList" id="roomSelected" title="เลือกห้องเรียนค่ะ">
                                            ระดับห้อง<%--<span style="float: right;">→</span>--%>
                                        </div>
                                        <div class="divList" id="quizSelected" title="เลือกควิซค่ะ">
                                            ชุดควิซ<%--<span style="float: right;">→</span>--%>
                                        </div>
        ...
        <ul id="Help">
            <li class="about2" style="z-index: 99;"><a title="ดูรายงานแบบละเอียด" id="HelpLogin"
                onclick="ShowHelp();">รายละเอียด </a></li>
        </ul>
    </div>
    ...
    <input type="hidden" id="HdFilterBtn" value="0" />
        <div id="DivBlock" style="background-color:gray;width:100%;height:100%;position:absolute;top:0px;left:0px;display:none;z-index:99999999999999999999999999;">
            asd
        </div>
