...
Public Class CreateParentGraph
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim MOService As New MaxOnetService
        ' MOService.UpdateParentReport()
        ...
        sql.Append(" where PG_IsActive = 1 and maxonet_tblKeyCodeUsage.KCU_IsActive = 1 and maxonet_tblKeyCodeUsage.KCU_Type = 1;")
...
#Region "GenChart"
    Private Sub CreateAndSaveQualityChart()
        ...
        With QualityChart
            ...
            Dim Index = 0
            Dim DateMinus = BaseGraph.Count - 1
            ...
            .Visible = True
            Dim TokenPath As String = Server.MapPath("~/Maxonet/ParentGraph/" & TokenId)
            If (Not System.IO.Directory.Exists(TokenPath)) Then
                System.IO.Directory.CreateDirectory(TokenPath)
            End If
            .Save(TokenPath & "/Quality.png", System.Drawing.Imaging.ImageFormat.Png)
        End With
    ...
    Private Sub CreateAndSaveQuantityChart()
        ...
        With QuantityChart
            ...
            If (Not System.IO.Directory.Exists(TokenPath)) Then
                System.IO.Directory.CreateDirectory(TokenPath)
            End If
            .Save(TokenPath & "/Quantity.png", System.Drawing.Imaging.ImageFormat.Png)
        End With
...
#Region "TestChart"
    ...
    Private Sub GenDataTestChart()
      
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "1/7"})
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "2/7"})
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "3/7"})
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "4/7"})
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "5/7"})
        QualityDailyPercent.Add(New With {.QualityDailyValue = "0", .DateDisplay = "6/7"})

        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "1/7"})
        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "2/7"})
        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "3/7"})
        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "4/7"})
        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "5/7"})
        QualityPracticePercent.Add(New With {.QualityPracticeValue = "0", .DateDisplay = "6/7"})

        CreateAndSaveQualityTestChart()


        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "1/7"})
        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "2/7"})
        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "3/7"})
        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "4/7"})
        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "5/7"})
        QuantityDailyPercent.Add(New With {.QuantityDailyValue = "0", .DateDisplay = "6/7"})

        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "1/7"})
        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "2/7"})
        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "3/7"})
        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "4/7"})
        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "5/7"})
        QuantityPracticePercent.Add(New With {.QuantityPracticeValue = "0", .DateDisplay = "6/7"})

        CreateAndSaveQuantityTestChart()
    End Sub

    Private Sub CreateAndSaveQualityTestChart()
        ...
        With QualityChart
            ...
            Dim Index = 0
            For Each a In BaseGraph
                .PlotArea.XAxis(Index).TextBlock.Text = DateAdd(DateInterval.Day, 0 - Index, Date0).ToString
                Index += 1
            Next
    ...
    Private Sub CreateAndSaveQuantityTestChart()
        ...
        With QuantityChart
            ...
            .PlotArea.XAxis.Appearance.LabelAppearance.Position.AlignedPosition = Telerik.Charting.Styles.AlignedPositions.Left
            Dim Index = 0
            For Each a In QualityDailyPercent
                .PlotArea.XAxis(Index).TextBlock.Text = DateAdd(DateInterval.Day, 0 - Index, Date0).ToString
                Index += 1
            Next
