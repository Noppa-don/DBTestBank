<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteDashboard.Master"
    CodeBehind="DashboardPracticePage.aspx.vb" Inherits="QuickTest.DashboardPracticePage" %>
                    ...
                    <center>
                        <telerik:RadChart ID="RadChartDashboard" runat="server" Width="890" Legend-Appearance-Visible="false"
                            ...
                            <PlotArea>
                                ...
                                <YAxis>
                                    <AxisLabel Visible="true">
                                        <TextBlock Text="จำนวนครั้ง" Appearance-Dimensions-Margins="500,500,500,500" Appearance-TextProperties-Color="Black"></TextBlock>
                                    </AxisLabel>
                                    <Appearance>
                            ...
                            <ChartTitle TextBlock-Text="จำนวนนร.(สีฟ้า) และ จำนวนครั้งที่เข้าทำฝึกฝน(สีเขียว) แยกรายห้อง">
